...
if ($button == 1)
	...
	$settings[1][0] = array('ignore'=>true,'limit'=>4,'shade_rows'=>true,'title'=>'Return Charges','s00'=>'T1.c01');
	$settings[2][0] = array('ignore'=>true,'shade_rows'=>true,'title'=>'Return Charges','s00'=>'T1.c01');
	$settings[3][0] = array('rows'=>15,'columns'=>30,'title'=>'Return Charges');	
    }
/* END GET DATA */
...
$params = array("select_class" => "margin", "label_class" => "padded", "label" => "Report Type: ");
$main->report_type($current['report_type'], $params);

//Report Variables and Button
//charge type selector
$arr_charge = array("Credit","Debit");
$params = array("label" => "Charge Type: ","select_class" => "margin", "label_class" => "padded");
